...
Создадим на Leaf-3 оба VRF и пропишем статические default маршруты в каждой VRF, настроим интерфейс до ISP с тэгированными саб интерфейсами, потому что можем:
...
Тоесть чтобы заработала связность между VM-1 и Leaf-2, нам нужно создать оба l2 vni c l3 интерфейсами и anycast gw на leaf-3.\
...
Полная конфигурация [LEAF-3](LEAF-3), на остальных кроме VRF изменений небыло.
